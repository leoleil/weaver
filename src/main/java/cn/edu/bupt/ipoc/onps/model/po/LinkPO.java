...
public class LinkPO {
    ...
    public LinkPO(String linkId, String name, String layer, String linkExpendId, String fromNodeId, String toNodeId, Double length, Double rate, Integer year, Integer caption, Integer carried, Integer size, Double utilization, String childNetNumber, String status, String survivance, Double error, String domain, Double weight, String type, Integer free, String fromPort, String toPort, String projectId, String networkId, Integer level) {
        this.linkId = linkId;
        this.name = name;
        this.layer = layer;
